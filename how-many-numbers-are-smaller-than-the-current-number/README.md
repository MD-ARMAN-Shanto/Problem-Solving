...
<pre style="position: relative;"><strong>Input:</strong> nums = [8,1,2,2,3]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [6,5,4,8]
<strong>Output:</strong> [2,1,0,3]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> nums = [7,7,7,7]
