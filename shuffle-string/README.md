...
<pre style="position: relative;"><strong>Input:</strong> s = "codeleet", <code>indices</code> = [4,5,6,7,0,2,1,3]
...
<pre style="position: relative;"><strong>Input:</strong> s = "abc", <code>indices</code> = [0,1,2]
