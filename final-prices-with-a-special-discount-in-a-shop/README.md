...
<pre style="position: relative;"><strong>Input:</strong> prices = [8,4,6,2,3]
...
<pre style="position: relative;"><strong>Input:</strong> prices = [10,1,1,6]
