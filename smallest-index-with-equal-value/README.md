...
<pre style="position: relative;"><strong>Input:</strong> nums = [0,1,2]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [4,3,2,1]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,3,4,5,6,7,8,9,0]
