...
<pre style="position: relative;"><strong>Input:</strong> s1 = "this apple is sweet", s2 = "this apple is sour"
...
<pre style="position: relative;"><strong>Input:</strong> s1 = "apple apple", s2 = "banana"
