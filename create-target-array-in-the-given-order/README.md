...
<pre style="position: relative;"><strong>Input:</strong> nums = [0,1,2,3,4], index = [0,1,2,2,1]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,3,4,0], index = [0,1,2,3,0]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1], index = [0]
