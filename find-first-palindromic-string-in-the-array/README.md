...
<pre style="position: relative;"><strong>Input:</strong> words = ["abc","car","ada","racecar","cool"]
...
<pre style="position: relative;"><strong>Input:</strong> words = ["notapalindrome","racecar"]
...
<pre style="position: relative;"><strong>Input:</strong> words = ["def","ghi"]
