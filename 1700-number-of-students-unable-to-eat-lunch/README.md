...
<pre style="position: relative;"><strong>Input:</strong> students = [1,1,0,0], sandwiches = [0,1,0,1]
...
<pre style="position: relative;"><strong>Input:</strong> students = [1,1,1,0,0,1], sandwiches = [1,0,0,0,1,1]
