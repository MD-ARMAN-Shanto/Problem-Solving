...
<pre style="position: relative;"><strong>Input:</strong> m = 2, n = 3, indices = [[0,1],[1,1]]
...
<pre style="position: relative;"><strong>Input:</strong> m = 2, n = 2, indices = [[1,1],[0,0]]
